...
export const WEEK_DATA: Record<number, WeekData> = {
  ...
  6: {
    ...
    babySizeDetail: 'Impossibly small, quietly miraculous.',
    babyDevelopment: 'Your baby\'s heart is now beating about 150 times a minute — twice as fast as yours. Tiny buds for arms and legs are beginning to appear, and the neural tube is closing.',
    bodyChanges: 'Nausea and exhaustion may be at their peak. These symptoms, however uncomfortable, are signs of an actively working pregnancy.',
    selfCareTip: 'Eat what you can manage. Rest without guilt. This is not the time to be productive — it\'s the time to simply be.',
    emotionalNote: 'Your discomfort is not weakness. It is your body doing something remarkable.',
    dailyInsight: 'The smallest heartbeats carry the largest possibility.',
  },
  8: {
    week: 8,
  ...
  10: {
    ...
    babySizeDetail: 'Fully formed in miniature — perfectly on their way.',
    babyDevelopment: 'Your baby now has tiny fingernails and working kidneys. All vital organs are present. They move freely inside the womb, though you won\'t feel it yet.',
    bodyChanges: 'Nausea may begin to ease for some. Your uterus is now the size of a grapefruit. The external changes are still subtle, but everything is in motion.',
    selfCareTip: 'Be patient with your body\'s timeline. Every pregnancy moves at exactly the pace it\'s meant to.',
    emotionalNote: 'What\'s happening inside you is beyond ordinary. Try to hold that quietly.',
    dailyInsight: 'Growth is usually invisible until it isn\'t.',
  },
  12: {
    week: 12,
    babySize: 'a lime',
  ...
  14: {
    week: 14,
    babySize: 'a lemon',
    babySizeDetail: 'Bright, vivid, and full of possibility.',
    babyDevelopment: 'Your baby can squint, frown, and make sucking movements. They\'re growing fine hair called lanugo, which keeps them warm. Their kidneys are producing urine.',
    bodyChanges: 'Welcome to the second trimester. Many women notice a welcome return of energy and appetite. Your body is finding a new kind of rhythm.',
    selfCareTip: 'If you haven\'t yet, this is a gentle time to begin prenatal yoga, slow walks, or swimming. Move in whatever way feels good.',
    emotionalNote: 'The relief that often arrives in the second trimester is earned. Let yourself feel it fully.',
    dailyInsight: 'After the quiet, the light often returns.',
  },
  16: {
    week: 16,
    babySize: 'an avocado',
  ...
  22: {
    week: 22,
    babySize: 'a papaya',
    babySizeDetail: 'Lush, warm, and beautifully full.',
    babyDevelopment: 'Your baby\'s senses are growing more refined. They can feel movement when you touch your belly. Eyebrows and eyelids are fully formed. They sleep and wake in distinct cycles.',
    bodyChanges: 'Your belly is unmistakably visible now. Strangers may begin to comment — and you get to decide exactly how much of this chapter you want to share.',
    selfCareTip: 'Compression socks, extra pillows, and slow mornings are all forms of wisdom right now. Receive each small comfort without guilt.',
    emotionalNote: 'You don\'t owe anyone access to this. It\'s yours to keep or share, as you choose.',
    dailyInsight: 'The world notices. But only you know what\'s really happening inside.',
  },
  24: {
    week: 24,
  ...
  26: {
    ...
    babySizeDetail: 'Leafy, layered, and almost impossibly real.',
    babyDevelopment: 'Your baby\'s eyes are now open and can sense light filtering through your belly. Their brain is developing rapidly, processing and beginning to store experience.',
    bodyChanges: 'You may notice stronger and more frequent fetal movement, especially in the evenings. Braxton Hicks may be beginning — your body quietly practicing.',
    selfCareTip: 'If kick counts bring you peace of mind, ten movements in two hours is a healthy benchmark. But trust your own sense of your baby too.',
    emotionalNote: 'Twenty-six weeks is the kind of milestone that asks you to pause and feel how far you\'ve come.',
    dailyInsight: 'What once felt far away is getting close now.',
  },
  28: {
    week: 28,
  ...
  30: {
    week: 30,
    babySize: 'a cabbage',
    babySizeDetail: 'Layered, substantial, and wonderfully full.',
    babyDevelopment: 'Your baby is now capable of regulating their own temperature. Their bone marrow has taken over red blood cell production, and they gain about half a pound each week from here.',
    bodyChanges: 'Your diaphragm is compressed, which can make breathing feel shallower. This is temporary — as baby descends in the final weeks, you\'ll breathe easier again.',
    selfCareTip: 'Prenatal massage, if accessible to you, can be deeply restorative right now. So can a warm bath, a quiet room, and no agenda.',
    emotionalNote: 'The weight of it all — physical and emotional — is real. Carry it gently, and with help when you can.',
    dailyInsight: 'You don\'t have to hold everything. Let some things rest.',
  },
  32: {
    week: 32,
    babySize: 'a squash',
  ...
  34: {
    ...
    babySizeDetail: 'Round, warm, and very nearly ready.',
    babyDevelopment: 'Your baby\'s lungs are nearly fully mature and practicing breathing movements. Their central nervous system is undergoing final refinements. They are almost ready.',
    bodyChanges: 'Baby may be settling into the birth position. The pressure on your pelvis can be significant — this is normal, and a sign your body is preparing beautifully.',
    selfCareTip: 'Write a letter to your baby, if you feel moved to. Or to yourself. You\'ll want this one day.',
    emotionalNote: 'You are further than you think and closer than it feels. Both are quietly true.',
    dailyInsight: 'Every day now is a gift you\'re giving.',
  },
  36: {
    week: 36,
  ...
  37: {
    ...
    babySizeDetail: 'Full of life and very nearly complete.',
    babyDevelopment: 'Your baby is considered "early term." Their brain continues to develop rapidly — the final weeks see significant neural growth. They\'re running out of room, and you both feel it.',
    bodyChanges: 'You may be dilating slowly without knowing it. Your body is preparing for birth in quiet, gradual ways — entirely on its own schedule.',
    selfCareTip: 'Let go of the timeline. Babies arrive when they\'re ready. Trust both of you.',
    emotionalNote: 'You are one of the most prepared people in the world for what\'s coming. You just can\'t feel it yet.',
    dailyInsight: 'The most important kind of ready lives quietly in your body.',
  },
  38: {
    week: 38,
    babySize: 'a winter melon',
    babySizeDetail: 'Full, complete, and utterly ready.',
    babyDevelopment: 'Your baby is fully developed and gaining small amounts of weight each day. Their immune system is being bolstered by antibodies transferred from you. They are ready.',
    bodyChanges: 'Lightning crotch, pelvic pressure, and strong Braxton Hicks are all common — signs your body is orchestrating something extraordinary without your having to think about it.',
    selfCareTip: 'Rest as much as possible. The energy you preserve now is the energy you\'ll have when you need it most.',
    emotionalNote: 'The waiting at the very end is its own kind of tender. You\'re almost there.',
    dailyInsight: 'Ready doesn\'t always feel like ready. But you are.',
  },
  40: {
    week: 40,
